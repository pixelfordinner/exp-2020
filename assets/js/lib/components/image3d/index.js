...
export class ImageTexture {
  constructor (app, config = {}) {
    ...
    this.gl.uniform2f(this.mouseLocation, this.mouse.pos.x, this.mouse.pos.y)
  ...
  async init () {
    ...
    this.map = new Image()
    this.map.src = '/dist/images/map-wood.jpg'
  ...
  onTick (delta) {
    ...
    const mpx = this.mouse.pos.x / this.canvas.width
    const mpy = this.mouse.pos.y / this.canvas.height
    this.gl.uniform2f(this.mouseLocation, mpx, mpy)
    // console.log(this.mouse.pos)

    // mat4.rotate(this.worldMatrix, this.rotMatrix, Math.PI, [0, 1, 0])
    // mat4.identity(this.rotMatrix)
    // mat4.rotate(this.worldMatrix, this.rotMatrix, Math.PI * Math.sin(this.time), [0, 1, 0])
