...
export class LeafComponent {
  ...
  setup () {
    ...
    const cs = this.palette.toHex(this.palette.complementary)
    const ce = this.palette.toHex('0xffffff')
    this.gradient = new Gradient(this.app, { colorStar: cs, colorEnd: ce })

    // console.log(this.gradient)

    this.shader = new ShaderComponent(this.app, {})
    // const nightmode = this.palette.nightMode
    // console.log(nightmode + ' N')
  ...
  doShape () {
    ...
    this.texture.drawRect(0, 0, 200, 200)
