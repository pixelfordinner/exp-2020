...
export class AvatarComponent {
  constructor (app, config = {}) {
    ...
    // this.container.position3d.x = 1000
    // this.container.position.y = 0
    // this.container.addChild(this.buffers.fill)

    // this.container.position3d.x = 200
  ...
  drawFill () {
    ...
    // this.buffers.fill.renderable = false

    this.texture = new PIXI.Texture(this.buffers.fill)
    const sp = new PIXI.projection.Sprite3d(this.texture)
    sp.position.x = this.centerx
    sp.position.y = this.centery
    sp.position3d.z = 400

    // this.camera.addChild(sp)
    // this.container.addChild(this.buffers.fill)
    // this.container.position.x = 400
  }
  ...
  getmask () {
    ...
    return this.buffers.fill.geometry
  }
  ...
  onTick (delta) {
    ...
    // this.transform()
    // this.container.euler.x += Math.cos(this.time) * 30
    // this.col()
    // this.shape()
  }
}
